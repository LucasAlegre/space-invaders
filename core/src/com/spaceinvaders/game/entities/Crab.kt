...
class Crab(x: Float, y: Float, timeInit: Float): Enemy(x=x, y=y, width=70f, height=70f, texture= GameScreen.crabTexture, speed=200f, score=100, lives=2, shootDelay=5f, timeInit=timeInit){
